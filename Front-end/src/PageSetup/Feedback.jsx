...
const FeedbackPage = () => {
  ...
  return (
    ...
    >
      <div className="w-[60vw] h-[70vh] flex-col rounded-2xl bg-[#EDEAE0] overflow-hidden border shadow-black shadow-2xl">
        <motion.h1
          className="text-5xl crete-round-regular text-center mt-6"
          variants={sharedVariants}
        >
          FEEDBACK
        </motion.h1>
          ...
          <motion.div className="w-[50%] flex flex-col pt-6 justify-center px-12" variants={sharedVariants}>
            <form onSubmit={handleSubmit} className="flex flex-col space-y-4 w-full">
              ...
              <motion.div variants={sharedVariants} className="flex justify-evenly">
                ...
                <Link to="/" className="transition-all underline pt-2 hover:scale-105">
                  Back to Home
                </Link>
              </motion.div>
              ...
              {/* Message */}
              <motion.div
                className={`min-h-[24px] text-m text-center ${error ? 'text-red-600' : 'text-green-600'}`}
                variants={sharedVariants}
              >
                {message}
              </motion.div>
