    ...
    return (
        <>
            ...
            <header>
                ...
                <nav className='h-16 w-full flex text-white bg-[#17111f] border-b-2 justify-between items-center p-4 '>
                    <div className='flex items-center'>
                        <img src="/images/logo.png" alt="" className='h-14 w-14' />
                        <h1 className='text-4xl crete-round-regular font-bold'>VARNA</h1>
                    </div>
                    <div className="flex space-x-10 text-lg px-10">
            ...
            <section>
                <div className="relative flex items-center w-full">
                    <img alt="" className="w-full h-[85vh]" src="/images/IMG-20250130-WA0084.jpg" />
                    <div className="absolute flex flex-col items-center p-8 left-40 ">
                        <h1 className="text-white text-4xl font-bold">
                            PRESENTING
                        </h1>
                        <h2 className="text-white font-bold text-8xl font-serif mt-4">
                            VARNA | <span className='kalam'>वर्ण</span>
                        </h2>
                        <p className="text-white font-bold text-2lg mt-4">
                            HERITAGE OF INDIAN WHITES &amp; IVORY
                        </p>
                        <p className="text-white font-bold text-2lg mt-4 text-center">
                            Rich. Luxurious. And understated. <br /> Add a touch of India’s opulent history to your space.
                        </p>
                        <button className="relative overflow-hidden px-4 py-3 mt-6 rounded-full font-bold text-black bg-[#F6F6F6] transition-all duration-500 hover:text-white
                            ...
                            before:duration-500 hover:before:w-full">
                            <Link to="/Signup" className="relative z-10">SIGN UP <i className="ri-arrow-right-line"></i></Link>
                        </button>
                        <div className="text-black mt-2  text-center flex">
                            <Link to="/Login" className="transition-all hover:underline hover:scale-105" href="#">
            ...
            {/* intro text section */}
            <section>
                <p className='mt-8 text-xl text-center px-20 leading-10 text-gray-700'>Painting your home is an exciting journey, but finding the perfect colours, high-quality products, and skilled painters—while ensuring a hassle-free experience—can be overwhelming.
            ...
            <section className="flex flex-col items-center text-white justify-center">
                <h3 className='text-6xl mt-12 text-black font-light text-center'>
                    Get the right assistance for all your painting needs
                </h3>

                <div className="w-[70vw] border border-white grid mt-8 md:grid-cols-2 gap-8 bg-[#425E8E] p-4 rounded-lg">
                    {/* Left Side - Image */}
                    <div className="flex">
                        <img src="/images/contact-image.jpg" alt="" className="w-full h-96 border border-white rounded-lg" />
                    </div>

                    {/* Right Side - Contact Form */}
                    <div className="border h-96 p-6 rounded-lg overflow-auto custom-scrollbar">
                        <form className="space-y-3" onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="relative px-4 py-2 text-m font-medium border overflow-hidden rounded-full text-white transition-all 
            ...
            <section className='mt-20 w-full relative'>
                ...
                <div className='h-full w-full absolute z-10 top-20 left-20  uppercase'>
                    <h1 className='text-5xl text-black leading-16 font-bold crete-round-regular'>WE PROVIDE <br /> Professional <br /> Painting Services  & <br /> Colour Visualization</h1>

                </div>
                <img src="/images/logo.png" alt="" className="h-20  w-20 absolute bottom-6 z-10 right-8" />
            </section>
