...
const AboutUs = () => {
    return (
        <section
            className="text-gray-800 px-6 pb-16 md:py-16 max-w-6xl mx-auto"
            id="about"
        >
            <div className="text-center mb-12">
                <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">About <span className="text-red-600">Varna</span></h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    Bringing color, art, and heritage to life with a modern touch.
                </p>
            </div>

            <div className="space-y-12 text-justify text-gray-700 text-lg leading-relaxed">
                <p>
                ...
                <div>
                    <h3 className="text-2xl font-bold text-red-600 mb-2">Who Are We?</h3>
                    <p>
                ...
                <div>
                    <h3 className="text-2xl font-bold text-red-600 mb-2">What Do We Do?</h3>
                    <p>
